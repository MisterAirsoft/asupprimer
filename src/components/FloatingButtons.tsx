...
const FloatingButtons = () => {
  const buttons = [
    { icon: Compass, label: 'QRcode', onClick: () => window.location.href='https://bolt.new/' },
    { icon: Fish, label: 'Ergonomie', onClick: () => console.log('Espèces clicked') },
    { icon: Map, label: 'Météo', onClick: () => console.log('Carte clicked') },
